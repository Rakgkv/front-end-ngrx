...
export class CountryListComponent implements OnInit {
  ...
  countrySource$: Observable<Country[]>;
  dataSource: any;
  ...
  ngOnInit(): void {
    this.countrySource$ = this.store.select(getCountries);
    // console.log("list" ,  this.countrySource$ )
    this.countrySource$.subscribe((countries: any) => {
      console.log('list data', countries);
